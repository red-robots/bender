...
<body <?php body_class(); ?>>
<?php do_action( 'bender_before_site_star' ); ?>
<div id="page" class="hfeed site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'bender' ); ?></a>
	<header id="masthead" class="site-header" role="banner">
		<div class="container">
			<div class="site-branding">
				<?php
				$site_text_logo =  get_bloginfo( 'name' );
				$site_image_logo = get_theme_mod( 'bender_site_image_logo' );
			...
			<div class="header-right-wrapper">
				<a href="#0" id="nav-toggle"><?php _e( 'Menu', 'bender' ); ?><span></span></a>
				<nav id="site-navigation" class="main-navigation" role="navigation">
					<ul class="bender-menu">
